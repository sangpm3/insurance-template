(function ($) {
  ...
  $(document).ready(function () {
      ...
      function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            // set Price
            var price = $(".mini-cart-main-content")
              .find(".get-cart-price")
              .html();
    ...
    //Update cart
    // $('.button[name="update_cart"],.product-remove a.remove').live(
    //   "click",
    //   function (e) {
          ...
          $('body input[name="variation_id"]').on("change", function () {
            ...
            if (id) {
              ...
              if ("image_id" in curent_data) {
                $(".product-list-thumb .thumbnails")
                  .find('a[data-image_id="' + curent_data.image_id + '"]')
                  .trigger("click");
              }
            }
          });
            ...
            $(".attr-hover-box").hover(function () {
              ...
              $(this)
                ...
                .each(function () {
                  ...
                  if (val != "") {
                    if (seff.hasClass("attr-color"))
                      content +=
                        "<li" +
                        el_class +
                        ' data-attribute="' +
                        val +
                        '"><a href="#"><span class="color-' +
                        val +
                        '"></span></a></li>';
                    else
                      content +=
