  ...
  var b = {
      init: function (e) {
        ...
        return this.each(function () {
          ...
          m.wrapInner(
            "<div class='mCustomScrollBox mCS-" +
              e.theme +
              "' id='mCSB_" +
              c(document).data("mCustomScrollbar-index") +
          ...
          if (e.horizontalScroll) {
            ...
            k.wrapInner(
              ...
              .css({ width: k.children().outerWidth(), position: "relative" })
              .unwrap();
          } else {
            g.wrapInner(
          ...
          if (e.scrollButtons.enable) {
            if (e.horizontalScroll) {
              l.prepend(
                "<a class='mCSB_buttonLeft' oncontextmenu='return false;'></a>"
              ).append(
          ...
          if (e.advanced.updateOnBrowserResize) {
            var i,
              ...
              u = c(window).height();
            c(window).bind(
              "resize." + m.data("mCustomScrollbarIndex"),
              function () {
                if (i) {
                  clearTimeout(i);
                }
            ...
            p = setInterval(function () {
              if (e.horizontalScroll) {
                if (e.advanced.autoExpandHorizontalScroll) {
                  o.css({ position: "absolute", width: "auto" })
                    .wrap(
                      "<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />"
                    )
                    .css({ width: o.outerWidth(), position: "relative" })
                    .unwrap();
                }
                var v = o.outerWidth();
              } else {
      ...
      update: function () {
        ...
        if (n.data("horizontalScroll")) {
          ...
          if (n.data("autoExpandHorizontalScroll")) {
            q.css({ position: "absolute", width: "auto" })
              .wrap(
                "<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />"
              )
              .css({ width: q.outerWidth(), position: "relative" })
              .unwrap();
          }
          var z = q.outerWidth();
        } else {
        ...
        if (i > r && !n.data("horizontalScroll")) {
          ...
          var B = m.height(),
            x = (i - r) / (s - B);
          n.data("scrollAmount", x).mCustomScrollbar(
            "scrolling",
            k,
            q,
            o,
      ...
      scrolling: function (i, q, n, k, A, f, D, w) {
          ...
          if (c.support.pointer || c.support.msPointer) {
            ...
            k.bind("mousedown touchstart", function (K) {
              ...
              if (K.type === "touchstart") {
                var L =
                  K.originalEvent.touches[0] ||
                  K.originalEvent.changedTouches[0];
                I = L.pageX - N.left;
                M = L.pageY - N.top;
              } else {
                l.data({ on_drag: true });
        ...
        if (c.support.touch && l.data("contentTouchScroll")) {
          if (!l.data("bindEvent_content_touch")) {
            ...
            q.bind("touchstart", function (x) {
              ...
              m =
                x.originalEvent.touches[0] || x.originalEvent.changedTouches[0];
              E = c(this);
              s = E.offset();
              v = m.pageX - s.left;
              t = m.pageY - s.top;
        ...
        if (!l.data("bindEvent_scrollbar_click")) {
          n.bind("click", function (I) {
            ...
            if (
              y.hasClass("mCSB_draggerContainer") ||
              y.hasClass("mCSB_draggerRail")
            ) {
            ...
            if (l.data("horizontalScroll")) {
              ...
              if (!l.data("bindEvent_buttonsPixels_x")) {
                w.bind("click", function (x) {
                  x.preventDefault();
                  r(
                    Math.abs(q.position().left) +
                      l.data("scrollButtons_scrollAmount")
                  );
                });
        ...
        if (l.data("autoScrollOnFocus")) {
          if (!l.data("bindEvent_focusin")) {
            i.bind("focusin", function () {
              ...
              if (
                x.is("input,textarea,select,button,a[tabindex],area,object")
              ) {
        ...
        if (!k.hasClass("mCS_no_scrollbar")) {
          ...
          if (e || e === 0) {
            ...
            if (i.data("horizontalScroll")) {
              ...
              d.mTweenAxis.call(
                ...
                f.scrollEasing,
                {
                  onStart: function () {
                    ...
                    if (
                      i.data("autoHideScrollbar") &&
                      !i.data("alwaysShowScrollbar")
                    ) {
              ...
              if (i.data("onTotalScroll_Offset")) {
                l =
                  g.height() - k.outerHeight() + i.data("onTotalScroll_Offset");
              }
              if (p < 0) {
                p = e = 0;
        ...
        function u(w) {
          if (i.data("mCustomScrollbarIndex")) {
            this.mcs = {
              ...
              topPct: Math.round(
                (100 * Math.abs(k.position().top)) /
                  Math.abs(k.outerHeight() - g.height())
              ),
              leftPct: Math.round(
                (100 * Math.abs(k.position().left)) /
                  Math.abs(k.outerWidth() - g.width())
              ),
            };
            switch (w) {
              case "onScrollStart":
      ...
      destroy: function () {
        var e = c(this);
        e.removeClass(
          "mCustomScrollbar _mCS_" + e.data("mCustomScrollbarIndex")
        )
      ...
      rafPolyfill: function () {
        ...
        while (--e > -1 && !window.requestAnimationFrame) {
          ...
          window.cancelAnimationFrame =
            window[f[e] + "CancelAnimationFrame"] ||
