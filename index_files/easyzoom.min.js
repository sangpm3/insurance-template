 ...
 */ !(function (a) {
  ...
  function b(b, c) {
    (this.$target = a(b)),
      (this.opts = a.extend({}, i, c, this.$target.data())),
  ...
  (b.prototype._init = function () {
    ...
    (b.prototype.show = function (a, b) {
      ...
      return this.isReady
        ? (this.$target.append(this.$flyout),
          ...
          void (a && this._move(a)))
        : this._loadImage(this.$link.attr("href"), function () {
    ...
    (b.prototype._onEnter = function (a) {
      ...
      (this.isMouseOver = !0),
        (b && 1 != b.length) || (a.preventDefault(), this.show(a, !0));
    }),
    ...
    (b.prototype._loadImage = function (b, c) {
      ...
      this.$target
        ...
        (this.$zoom = a(d)
          ...
          .on("load", c, a.proxy(this._onLoad, this))),
