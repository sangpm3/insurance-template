            ...
            : function (d, u) {
                ...
                for (; h--; ) {
                  for (
                    ...
                    i || a.appendChild(C(s, !1)), (i = null);
                  }
                  e &&
                    (n < t.length && a.appendChild(C(t.slice(n), !0)),
    ...
    (c.wp.emoji = new (function () {
      ...
      function s() {
        if (!t) {
          if (void 0 === c.twemoji) {
            if (600 < r) return;
            return c.clearTimeout(u), (u = c.setTimeout(s, 50)), void r++;
          }
          (n = c.twemoji),
            (t = !0),
            e &&
                ...
                for (var e, t, n, a, r = u.length; r--; ) {
                  if (
                    ...
                    1 === (n = e.length) &&
                      ...
                      "IMG" === t[0].nodeName &&
                      e[0].data === t[0].alt &&
                      "load-failed" === t[0].getAttribute("data-error"))
                  )
                    return;
                  for (; n--; ) {
                    if (3 === (a = e[n]).nodeType) {
                    ...
                    !a ||
                      ...
                      (a.className &&
                        ...
                        -1 !== a.className.indexOf("wp-exclude-emoji")) ||
                      (d(a.textContent) && f(a));
                  }
                }
      ...
      function f(u, e) {
        var t;
        return !l.supports.everything &&
          n &&
          u &&
          ("string" == typeof u || (u.childNodes && u.childNodes.length))
          ? ((e = e || {}),
            (t = {
              ...
              callback: function (u, e) {
                ...
                return (
                  !(
                    l.supports.everythingExceptFlag &&
                    !/^1f1(?:e[6-9a-f]|f[0-9a-f])-1f1(?:e[6-9a-f]|f[0-9a-f])$/.test(
                      u
                    ) &&
                    !/^(1f3f3-fe0f-200d-1f308|1f3f4-200d-2620-fe0f)$/.test(u)
                  ) && "".concat(e.base, u, e.ext)
                );
              },
              attributes: function () {
                return { role: "img" };
      ...
      return (
        l && (l.DOMReady ? s() : (l.readyCallback = s)), { parse: f, test: d }
      );
    })());
