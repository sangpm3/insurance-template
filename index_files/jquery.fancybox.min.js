  ...
  c.extend(h, {
    ...
    open: function (a, b) {
      if (a && (c.isPlainObject(b) || (b = {}), !1 !== h.close(!0)))
        return (
              ...
              m(i) &&
                (n ||
                  (h.isImage(i)
                    ...
                    : m(f) && ((n = "html"), (k = f))),
                "ajax" === n &&
                  ((p = i.split(/\s+/, 2)), (i = p.shift()), (q = p.shift()))),
              k ||
                ("inline" === n
                  ? i
          ...
          b.keys !== d &&
            (h.opts.keys = !!b.keys && c.extend({}, h.defaults.keys, b.keys)),
          (h.group = a),
    ...
    jumpto: function (a, b, c) {
      ...
      e &&
        ...
        (h.router = c || "jumpto"),
        e.loop &&
          (a < 0 && (a = e.group.length + (a % e.group.length)),
          (a %= e.group.length)),
          ...
          g.bind("keydown.fb", function (e) {
            ...
            e.ctrlKey ||
              ...
              c.each(b, function (b, g) {
                return a.group.length > 1 && g[f] !== d
                  ? (h[b](g[f]), e.preventDefault(), !1)
                  : c.inArray(f, g) > -1
                  ? (h[b](), e.preventDefault(), !1)
                  : void 0;
              });
          }),
        c.fn.mousewheel &&
    ...
    _afterLoad: function () {
      ...
      if ((h.hideLoading(), a && !1 !== h.isActive)) {
        if (!1 === h.trigger("afterLoad", a, b))
          return (
            a.wrap.stop(!0).trigger("onReset").remove(), void (h.coming = null)
          );
        switch (
          (b &&
            ...
            e.selector
              ...
              : l(f) &&
                ...
                e.wrap.bind("onReset", function () {
                  c(this).find(f).length &&
                    f.hide().replaceAll(f.data(d)).data(d, !1);
                }));
            break;
          case "image":
        ...
        (l(f) && f.parent().is(e.inner)) || e.inner.append(f),
          ...
          h.bindEvents(),
          h.isOpened
            ? b.prevMethod && h.transitions[b.prevMethod]()
            : c(".fancybox-wrap")
                .not(e.wrap)
                .stop(!0)
                .trigger("onReset")
        ...
        if (((L = j.content), j.autoHeight && 1 === L.data("ready")))
          try {
            L[0].contentWindow.document.location &&
              ...
              u && M.css("overflow-x", "hidden"),
              (D = M.outerHeight(!0)));
          } catch (a) {}
      } else
        (j.autoWidth || j.autoHeight) &&
      ...
      c.scrollbarWidth === d &&
        ...
        c.support.fixedPosition === d &&
          (c.support.fixedPosition = (function () {
            var a = c('<div style="position:fixed;top:20px;"></div>').appendTo(
                "body"
              ),
