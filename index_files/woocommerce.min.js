jQuery(function (i) {
  ...
  var o =
    "store_notice" + (i(".woocommerce-store-notice").data("notice-id") || "");
    ...
    i(".woocommerce-input-wrapper :input")
      .on("keydown", function (e) {
        ...
        if (27 === e.which && o.length && o.is(":visible"))
          return o.prop("aria-hidden", !0).slideUp(250), e.preventDefault(), !1;
      })
      .on("click focus", function () {
        ...
        e.addClass("currentTarget"),
          ...
          o.length &&
            o.is(":hidden") &&
            o.prop("aria-hidden", !1).slideDown(250),
          e.removeClass("currentTarget");
      }),
    (i.scroll_to_notices = function (e) {
      e.length &&
        i("html, body").animate({ scrollTop: e.offset().top - 100 }, 1e3);
    });
});
